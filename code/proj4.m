...
%             size_mtx = [50, 100, 200, 400];
%             for i = 1 : 4
%                 vocab_size = size_mtx(i)
%                 vocab = build_vocabulary(train_image_paths, vocab_size);
%                 fileName = strcat('vocab', int2str(vocab_size), '.mat');
%                 save(fileName, 'vocab')
%             end
...
%         ldFileName = {'vocab50.mat'; 'vocab100.mat'; 'vocab200.mat'; 'vocab400.mat'};
%         svFileName_train = {'image_feats_train_50.mat'; 'image_feats_train_100.mat'; 'image_feats_train_200.mat'; 'image_feats_train_400.mat'};
%         svFileName_test = {'image_feats_test_50.mat'; 'image_feats_test_100.mat'; 'image_feats_test_200.mat'; 'image_feats_test_400.mat'};
%         for a = 1 : 4
%             train_image_feats = get_bags_of_sifts(train_image_paths, ldFileName{a});
%             save(svFileName_train{a}, 'train_image_feats')
%             test_image_feats  = get_bags_of_sifts(test_image_paths, ldFileName{a});
%             save(svFileName_test{a}, 'test_image_feats')
%         end
...
%         svFileName_test = {'image_feats_test_50.mat'; 'image_feats_test_100.mat'; 'image_feats_test_200.mat'; 'image_feats_test_400.mat'};
%         for i = 1 : 4
%             load(svFileName_train{i})
%             load(svFileName_test{i})
%             predicted_categories(:, i) = nearest_neighbor_classify(train_image_feats, train_labels, test_image_feats, 5);
%         end
